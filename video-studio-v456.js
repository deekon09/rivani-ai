...
const RIVANI_VIDEO_BUILD="V45.6-SUBJECT-MATTE";
queueMicrotask(()=>{if(el.engineNote)el.engineNote.textContent="V45.6 ENGINE ACTIVE · connected-subject matte + native VP9 alpha loaded";console.info("RIVANI Video Studio",RIVANI_VIDEO_BUILD);});
...
el.clear?.addEventListener("click",()=>{
  ...
  el.preview.disabled=true;el.exportBtn.disabled=true;
  el.engineStatus.textContent="Not loaded";el.personStatus.textContent="Waiting";el.faceStatus.textContent="Waiting";el.stabilityStatus.textContent="Waiting";
  el.engineNote.textContent="V45.6 ENGINE ACTIVE · connected-subject matte + native VP9 alpha loaded";
});
...
function resetControls(){
  el.edgeClean.value=54;el.feather.value=.35;el.temporal.value=20;el.light.value=18;el.smooth.value=18;el.glow.value=0;el.clarity.value=10;el.warmth.value=6;
