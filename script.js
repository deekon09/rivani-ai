...
function lukiFallbackReply(raw){
  ...
  if(/(image to text|ocr|extract text|screenshot to text|photo to text|scan to text|receipt|table to csv|multilingual ocr|handwriting)/.test(q))return 'Image to Text / OCR is live in Public Beta All Access. It extracts editable text from photos, screenshots, scanned pages and receipts in the browser, supports English, Hindi and several Indian-language OCR choices, and includes Auto Clean, Tiny Text Upscale, Smart OCR Race, confidence review, batch extraction, privacy-pattern scan and TXT/Markdown/JSON plus best-effort table-to-CSV export. Handwriting mode is experimental and important names, numbers and official text should always be reviewed.';
