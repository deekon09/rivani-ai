...
(function patchLukiV37(attempt=0){
  ...
  const ocrReply='RIVANI Image to Text / OCR is live in Public Beta All Access. It extracts editable text from photos, screenshots, scanned pages and receipts in the browser. It supports Indian languages plus major world-language OCR choices including Spanish, French, German, Portuguese, Arabic, Chinese, Japanese, Korean and Russian, Auto Clean, Tiny Text Upscale, Smart OCR Race, confidence review, batch extraction, privacy-pattern scan, TXT/Markdown/JSON export and best-effort Table to CSV. Handwriting is Experimental and important names, numbers and official text should be reviewed.';
