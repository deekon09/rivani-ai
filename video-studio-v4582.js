...
const RIVANI_VIDEO_BUILD="V45.8.2-UNIQUE-MODULE-HOTFIX";
queueMicrotask(()=>{if(el.engineNote)el.engineNote.textContent="V45.8.2 OFFLINE EXPORT READY · bitrate fix verified · original settings";console.info("RIVANI Video Studio",RIVANI_VIDEO_BUILD);});
...
el.clear?.addEventListener("click",()=>{
  ...
  el.preview.disabled=true;el.exportBtn.disabled=true;
  el.engineStatus.textContent="Not loaded";el.personStatus.textContent="Waiting";el.faceStatus.textContent="Waiting";el.stabilityStatus.textContent="Waiting";
  el.engineNote.textContent="V45.8.2 OFFLINE EXPORT READY · bitrate fix verified · original settings";
});
